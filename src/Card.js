...
export function Card(){
    ...
    return (
        <div>
            <h1>Beer</h1>
            <input type="text" name="search-beer"  id="search" placeholder="search by name" onChange={handleSearch} />
            ...
            <div className="header">
                ...
                <div className="menu">
                    <button onClick={()=>deleteItem(index)} type="button" className="delete">delete</button>
                </div>
            </div>
